return function()
	...
	local icons = {
		cmp = Load("util.icons").get("cmp", true),
		diagnostics = Load("util.icons").get("diagnostics", true),
		kind = Load("util.icons").get("kind", true),
		type = Load("util.icons").get("type", true),
		ui = Load("util.icons").get("ui", true),
	}
